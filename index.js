        ...
        let answers = await inquirer
            ...
            switch (answers.operator) {
                case " + Addition":
                    ...
                    await timer(1500);
                    spinner.success({
                        text: `${answers.number1} + ${answers.number2} = ${answers.number1 + answers.number2}\n`,
                    });
                    break;
                case " - Subtraction":
                ...
                case " x Multiplication":
                    ...
                    await timer(1500);
                    spinner.success({
                        text: `${answers.number1} x ${answers.number2} = ${answers.number1 * answers.number2}\n`,
                    });
                    break;
                case " ÷ Division":
                    spinner = createSpinner("Calculating result ... ").start();
